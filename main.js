...
var require_constants = __commonJS({
  "node_modules/@google-cloud/vertexai/build/src/util/constants.js"(exports) {
    ...
    var CLIENT_LIBRARY_VERSION = "1.10.0";
...
var require_util4 = __commonJS({
  "node_modules/@google-cloud/vertexai/build/src/functions/util.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_common3 = __commonJS({
  "node_modules/@google-cloud/vertexai/build/src/types/common.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_tool = __commonJS({
  "node_modules/@google-cloud/vertexai/build/src/types/tool.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_cached_contents = __commonJS({
  "node_modules/@google-cloud/vertexai/build/src/resources/cached_contents.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_api_client = __commonJS({
  "node_modules/@google-cloud/vertexai/build/src/resources/shared/api_client.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_resources = __commonJS({
  "node_modules/@google-cloud/vertexai/build/src/resources/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var VertexService = class {
  ...
  getVertexClient() {
    ...
    this.vertexClient = new import_vertexai.VertexAI({
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        if (data.models && data.models.length > 0) {
          const fetched = data.models.map((m) => m.displayName || m.name).filter((name) => typeof name === "string");
  ...
  async chat(prompt, context, vaultService, history = [], images = [], signal) {
    ...
    return async function* () {
      var _a;
      try {
        const client = self2.getVertexClient();
...
Then provide your final answer.`;
        if (self2.customContextPrompt) {
          systemInstructionText += `

USER CUSTOM INSTRUCTIONS:
${self2.customContextPrompt}`;
        }
        const tools = [
          {
...
User Question: ${prompt}` }];
        ...
        for (let i = 0; i < 5; i++) {
          ...
          if (!result.candidates || result.candidates.length === 0) {
            if ((_a = result.promptFeedback) == null ? void 0 : _a.blockReason) {
          ...
          if ("functionCall" in part && part.functionCall) {
            ...
            try {
              if (name === "list_files") {
                result2 = await vaultService.listMarkdownFiles();
              } else if (name === "read_file") {
                result2 = await vaultService.getFileContent(args.path);
              } else if (name === "search_content") {
                result2 = await vaultService.searchVault(args.query);
              } else if (name === "create_note") {
                await vaultService.createNote(args.path, args.content);
                result2 = { status: "success", message: `Note created at ${args.path}` };
              } else if (name === "create_folder") {
                await vaultService.createFolder(args.path);
                result2 = { status: "success", message: `Folder created at ${args.path}` };
              } else if (name === "delete_file") {
                await vaultService.deleteFile(args.path);
                result2 = { status: "success", message: `File deleted at ${args.path}` };
              } else if (name === "list_directory") {
                result2 = await vaultService.listDirectory(args.path);
              }
            } catch (err) {
              result2 = { status: "error", message: err.message };
            }
